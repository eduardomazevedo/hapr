...
hapr_mle_survival_gamma_nll_split_grad_cpp <- function(params, event_time, gc_event, X_w_event, censor_time, gc_censor, X_w_censor, post_c_over_a, model_type, use_openmp) {
