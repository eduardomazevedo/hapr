#' Extrapolate HAPR results given future R-squared to get full fit: linear model.
#'
...
#' @return A hapr_lm_full_fit object containing the results of the second stage
#' @export
hapr_lm_second_stage <- function(
  ...
  # Varinca of eta
  var_eta <- first_stage$var_error_y_on_gc_and_w - posterior$c ^ 2
